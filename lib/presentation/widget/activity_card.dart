...
class ActivityCard extends StatefulWidget {
  ...
  final TouristicAttraction activity;

  @override
  State createState() => _ActivityCardState();
}
...
class _ActivityCardState extends State<ActivityCard> {
                          ...
                          children: <Widget>[
                            Text(
                              (widget.activity.price == 0)
                                  ? Strings.activityCardTextFree
                                  : Strings.activityCardTextPay,
                              style: const TextStyle(
                            ...
                            Text(
                              (widget.activity.distance == 0)
                                  ? Strings.activityCardTextIn
                                  : Strings.activityCardTextOut,
                              style: const TextStyle(
                                  fontSize: 10, color: Colors.white),
                            )
                          ],
  ...
  void navigateToHowToReachScreen() {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => HowToReachPage(attraction: widget.activity)));
  }
  ...
  void navigateToInfoScreen() {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => InfoPage(attraction: widget.activity)));
  }
}
